    ...
    public void execute() {
        ...
        switch (Constants.state) {
            case DEFAULT:
                ...
                if (controller.getYButtonPressed()) {elbowAngle+=0.001;}
                if (controller.getAButtonPressed()){elbowAngle-=0.001;} 
        ...
        s_Upper.setElbow(-elbowPID.calculate(   - s_Upper.getElbowRotation()));
